        ...
        <section className="relative flex items-center justify-center min-h-[600px] max-h-[720px] w-full pt-20 overflow-hidden animate-fade-in">
            ...
            <div className="relative z-10 max-w-2xl mx-auto text-center text-light px-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#contact" className="px-8 py-3 rounded-full bg-blue-400 text-navy font-semibold shadow-lg hover:bg-accent hover:text-white hover:text-light transition-all duration-200 scale-100 hover:scale-105 focus:ring-2 focus:ring-blue-400 focus:outline-none">
                        Đặt lịch tư vấn
                    </a>
